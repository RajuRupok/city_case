...
@section('breadcrumb_section')
    ...
    <li class="breadcrumb-item">
      <a href="{{ route('service_manager.support_staff.index') }}">All Support Staffs</a>
    </li>
                ...
                <div class="card author-box">
                    ...
                    <div class="card-footer text-center pt-0">
                        @if ($support_staff->status == 'active')
                            <a href="{{ route('service_manager.support_staff.status', ['id' => $support_staff, 'status' => 'inactive']) }}" class="btn btn-dark confirmation">Deactivate</a>
                        @elseif ($support_staff->status == 'inactive')
                            <a href="{{ route('service_manager.support_staff.status', ['id' => $support_staff, 'status' => 'active']) }}" class="btn btn-dark confirmation">Activate</a>
                        @endif

                        <a href="{{ route('service_manager.support_staff.edit', ['id' => $support_staff->id]) }}" class="btn btn-dark m-l-5">Edit</a>
                    </div>
                </div>
            </div>
                                ...
                                <tbody>
                                    @foreach ($cases as $sl => $case)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('service_manager.case.show', ['id' => $case->id]) }}" target="_blank" class="btn btn-dark btn-sm">Details</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
