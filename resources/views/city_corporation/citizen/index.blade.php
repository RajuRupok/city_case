...
@section('page_title', 'All Citizens')
...
@section('breadcrumb_section')
    ...
    <li class="breadcrumb-item active">All Citizens</li>
@endsection
                    ...
                    <thead>
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>{{ $date }}</td>
                              <td class="text-uppercase text-bold" style="font-weight: 900;">{{ $citizen->status }}</td>
                              <td>
