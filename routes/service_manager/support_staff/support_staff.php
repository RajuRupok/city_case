...
Route::group([
    ...
    function(){
        ...
        Route::get('/all/edit/{id}', 'SupportStaffController@edit')->name('edit');
        Route::post('/update/{id}', 'SupportStaffController@update')->name('update');

        Route::get('/status/{id}/{status}', 'SupportStaffController@status')->name('status');
    }
);
